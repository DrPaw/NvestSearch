...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
		...
		echo"<div class='home-list-pop list-spac'>
									<!--LISTINGS IMAGE-->"?>
									<?php
									echo"<div class='col-md-3 list-ser-img'> 
									<img src='data:image/jpeg;base64,".base64_encode($row["image"])."' /> 
									</div>
									<!--LISTINGS: CONTENT-->
									
									<div class='col-md-9 home-list-pop-desc inn-list-pop-desc'> 
									<a href='TraderDetails.php?sn=".$row["sn"]."'>
									
									<h3>";?><?php echo "<td>".$row["username"]."</td></h3></a>"?>
									<?php 
										
										echo "<p><b>Payment method : </b><td>".$row["paymentmethod"]."</td></p>"?>
										<?php
										echo "<p><b>Price / BTC:</b> 3888.522033 USD</p>
										<p><b>Limits : </b> <td>".$row["minamount"]."</td> - <td>".$row["maxamount"]."</td></p>
										<div class='list-number'>
											<ul>
												<li><img src='images/icon/phone.png'> +01 1245 2541, +62 6541 6528</li>
												<li><img src='images/icon/mail.png'> localdir@nvest.com</li>
											</ul>
										...
										<div class='list-enqu-btn'>
											<ul>
												...
												<li><a href='#!' data-dismiss='modal' data-toggle='modal' data-target='#list-quo'><i class='fa fa-usd' aria-hidden='true'></i>BUY</a> </li>
											</ul>
										</div>
									</div>
								</div>";
