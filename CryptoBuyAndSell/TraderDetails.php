...
{
$sn=$_GET['sn'];
$sql="select seller,paymentmethod,tradelimit,image from buysellrecord where sn='$sn'";
...
if (mysqli_num_rows($result) > 0) {
	...
	echo "<section class='pg-list-1' style='background-image:url(images/pay4.png);'>
		<div class='container'>
			<div class='row'>
				<div class='pg-list-1-left'><h3>".$row["seller"]."</h3>
...
<p style='padding-top:10px;'><b>Payment method : </b>".$row["paymentmethod"]."</p>
<p><b>Price / BTC : </b> 3888.522033 USD</p>
<p><b>Limits : </b>".$row["tradelimit"]."</p>
<div class='list-number pag-p1-phone'>
<ul>
<li><i class='fa fa-phone' aria-hidden='true'></i> +01 1245 2541</li>
<li><i class='fa fa-envelope' aria-hidden='true'></i> localdir@nvest.com</li>
