...
<div class="col text-primary"><i class="fa fa-user"></i> <?php 
include_once('../nvestbuysellconfig.php');
...
<div class="w-100 pt-1"></div>
<div class="col"><strong>Min. amount:</strong></div>
<div class="col"><?php 
include_once('../nvestbuysellconfig.php');
...
<div class="card-body">
<h5 class="card-title">How much you wish to sell?</h5>
...
<h5 class="card-title">Sign up and sell bitcoins instantly.</h5>
